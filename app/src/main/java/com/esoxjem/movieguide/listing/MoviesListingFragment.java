...
import com.esoxjem.movieguide.util.EndlessRecyclerOnScrollListener;
    ...
    private void initLayoutReferences()
    {
        ...
        scrollListener = new EndlessRecyclerOnScrollListener(layoutManager) {
            ...
            public void onLoadMore(int current_page) {
                //Log.d("Onload","onload");
                //loadingStarted();
                moviesPresenter.displayMovies(current_page);
            }
        };
        moviesListing.addOnScrollListener(scrollListener);
